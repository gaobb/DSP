...
%    replace  imdb.images.label with  imdb.images.class 2015-05-31 by gaobb
...
devkitPath = fullfile(opts.dataDir, d(3).name) ;
...
imdb.images.class = horzcat(imdb.images.class, labels') ;
...
ok = imdb.images.class >  0 ;
imdb.images.class(ok) = relabel(imdb.images.class(ok)) ;
...
if opts.lite
  ...
  imdb.images.class = imdb.images.class(keep) ;
end
